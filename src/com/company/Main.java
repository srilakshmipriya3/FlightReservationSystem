...
public class Main {
    ...
    public static void main(String[] args) {
	 write your code hereTicket ticket1 = new RegularTicket("Breakfast", "1234ERTY", "Dubai", "Kochi", "6", "12", "14D", 110.0f, false, "EMIR1234", "ETIHAD AIRLINES", 120, 90, "Street", "Abu Dahbi", "UAE", "Denin", "9037774217", "deninthomas@outlook.com");
